...
The goal of this project is to explore the adaptive potential of the DNA methylation in sub-population of <i>Daphnia magna</i>, separated through time.

## Current Goals
This project has only just started so any contribution is welcome.
